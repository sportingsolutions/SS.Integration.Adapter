...
namespace SS.Integration.Adapter.Interface
{
    public interface IEventState
    {
        ...
        IEnumerable<string> GetFixtures(string sport);
        void RemoveInactiveFixtures(string sport, List<IResourceFacade> activeFixtures);

        int GetCurrentSequence(string sport, string fixtureId);
