...
namespace SS.Integration.Adapter.Tests
{
    ...
    public class StreamListenerActorTests : TestKit
    {
        ...
        public void ShouldThrowErrorOnProcessFirstSnapshotOnInitialization()
        {
            Mock<IResourceFacade> resourceMock = new Mock<IResourceFacade>();
            resourceMock.Setup(o => o.Id).Returns(_fixtureId);
            _stateManagerMock.Setup(o => o.CreateNewMarketRuleManager(It.Is<string>(id => id.Equals(_fixtureId))))
            ...
            //AwaitAssert(() =>,TimeSpan.FromMilliseconds(1000));
        }
        */
